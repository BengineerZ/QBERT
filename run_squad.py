...
def run_squad_w_args(args):
    ...
    # if os.path.exists(
    #        args.output_dir) and os.listdir(
    ...
    if args.do_predict and (args.local_rank == -1
        ...
        loss = total_loss / global_step if args.do_train else None
        result = {}
        result['loss'] = loss

        # evaluation
        from utils.squad_evaluate_v1_1 import evaluate
        ...
        result.update(evaluate(dataset, predictions))
